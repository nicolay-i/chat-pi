...
import { CreateProjectInputSchema, UpdateProjectInputSchema, ValidateRepoInputSchema } from '@pi-agents/contracts';
...
export const projectRouteOperationIds = [
  'projects.list', 'projects.create', 'projects.get', 'projects.update', 'projects.delete', 'projects.validate',
] as const;

export function createProjectRoutes({ projectService }: ServiceContainer): Hono {
