...
export const apiOperations = [
  ...
  operation('packages.list', 'GET', '/api/projects/:projectId/packages', PackageManifestSchema.array(), true),
  operation('packages.resolve', 'POST', '/api/projects/:projectId/packages/resolve', PackageInstallResultSchema, true),
  operation('packages.install', 'POST', '/api/projects/:projectId/packages/install', PackageInstallResultSchema, true),
  operation('packages.trust', 'POST', '/api/projects/:projectId/packages/:installId/trust', PackageInstallResultSchema, true),
  operation('packages.remove', 'DELETE', '/api/projects/:projectId/packages/:installId', z.object({ ok: z.boolean() }), true),
...
export const apiClientOperationIds = [
  ...
  'projects.list', 'projects.get', 'projects.create', 'projects.update', 'projects.delete', 'projects.validate',
  'chats.list', 'chats.get', 'chats.create', 'chats.bootstrap', 'chats.update', 'chats.archive', 'chats.export', 'chats.tree', 'chats.trace',
  'messages.send', 'chats.abort',
  'tasks.steer', 'tasks.followUp', 'tasks.abort', 'tasks.abortAndReplace', 'tasks.list', 'tasks.get', 'tasks.trace', 'tasks.fork', 'tasks.rollback', 'tasks.rebase', 'tasks.merge', 'tasks.archive',
  ...
  'packages.list', 'packages.resolve', 'packages.install', 'packages.trust', 'packages.remove',
