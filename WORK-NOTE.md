...
- Web shell проекта адаптирован для телефона: при ширине меньше 768 px
  навигация становится горизонтальной, основной экран занимает всю ширину,
  правая context-панель скрыта. Полоса навигации имеет фиксированную высоту
  48 px и не оттесняет содержимое экрана вниз.
...
- Полные monorepo `typecheck` и тесты прошли; Mobile lint завершился без
  ошибок, но со 103 предупреждениями.
