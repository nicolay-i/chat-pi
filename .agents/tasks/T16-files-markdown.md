# T16-files-markdown — File browser and Markdown viewer

## Goal

Файлы, Markdown preview, search, frontmatter.
...
- `app-starter/src/features/files`
